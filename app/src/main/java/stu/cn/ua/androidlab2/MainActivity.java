...
import stu.cn.ua.androidlab2.contract.AppContract;
import stu.cn.ua.androidlab2.contract.ResponseListener;
import stu.cn.ua.androidlab2.fragments.MenuFragment;
import stu.cn.ua.androidlab2.fragments.OptionsFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public void toOptionsScreen(Fragment target,
        ...
        launchFragment(target,
                OptionsFragment.newInstance(player));
    }

    @Override
    public void toQuestionsScreen(Fragment target,
                                  Player player) {
        launchFragment(target,
                QuestionsFragment.newInstance(player));
    }
    @Override
    public void cancel() {
